...
import { Users, DollarSign, Activity, Calendar, Radio, Plus } from 'lucide-react';
  ...
  return (
    <div style={{ padding: '32px 40px', maxWidth: 1400, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 28, flexWrap: 'wrap', gap: 16 }}>
        <div>
          <div style={{ fontSize: '0.72rem', color: '#6366f1', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
            MANAGEMENT CONSOLE
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24, marginBottom: 28 }}>
        <div className="mgms-card" style={{ padding: 24 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            <div style={{ width: 38, height: 38, borderRadius: 10, background: '#f5f3ff', color: '#6366f1', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Users size={20} />
            </div>
            <span style={{ fontSize: '0.74rem', color: '#10b981', fontWeight: 700 }}>+12.5%</span>
          </div>
          <div style={{ fontSize: '0.78rem', color: '#64748b', fontWeight: 600 }}>Global Active Players</div>
          <div style={{ fontSize: '2rem', fontWeight: 800, color: '#0f172a', fontFamily: 'Outfit', marginTop: 4 }}>
            2,482,194
          </div>
        </div>
        ...
        <div className="mgms-card" style={{ padding: 24 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            ...
            <span style={{ fontSize: '0.74rem', color: '#10b981', fontWeight: 700 }}>+4.2%</span>
          </div>
          <div style={{ fontSize: '0.78rem', color: '#64748b', fontWeight: 600 }}>Total Revenue (24h)</div>
          <div style={{ fontSize: '2rem', fontWeight: 800, color: '#0f172a', fontFamily: 'Outfit', marginTop: 4 }}>
            $1.24M
          </div>
        </div>
        ...
        <div className="mgms-card" style={{ padding: 24 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            ...
            <span style={{ fontSize: '0.74rem', color: '#10b981', fontWeight: 700 }}>-8.1%</span>
          </div>
          <div style={{ fontSize: '0.78rem', color: '#64748b', fontWeight: 600 }}>Average Server Latency</div>
          <div style={{ fontSize: '2rem', fontWeight: 800, color: '#0f172a', fontFamily: 'Outfit', marginTop: 4 }}>
            42ms
          </div>
        </div>
      ...
      <div className="mgms-card" style={{ padding: 28, marginBottom: 28 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          <div>
            <h3 style={{ fontSize: '1.15rem', fontWeight: 700, color: '#0f172a' }}>User Growth Trends</h3>
            <div style={{ fontSize: '0.8rem', color: '#64748b' }}>DAU/MAU performance across global clusters</div>
          </div>
        ...
        <div style={{ height: 200, width: '100%' }}>
          <svg viewBox="0 0 800 160" style={{ width: '100%', height: '100%' }}>
            ...
            <path d="M 0 130 Q 200 90, 400 100 T 800 40" fill="none" stroke="#06b6d4" strokeWidth="2.5" />
            <path d="M 0 150 Q 200 120, 400 125 T 800 70 L 800 160 L 0 160 Z" fill="rgba(99, 102, 241, 0.2)" />
            <path d="M 0 150 Q 200 120, 400 125 T 800 70" fill="none" stroke="#6366f1" strokeWidth="3" />
          </svg>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 24 }}>
        ...
        <div className="mgms-card" style={{ padding: 24 }}>
          <h3 style={{ fontSize: '1.05rem', fontWeight: 700, color: '#0f172a', marginBottom: 2 }}>Recent High-Value Purchases</h3>
          <div style={{ fontSize: '0.78rem', color: '#64748b', marginBottom: 16 }}>Latest financial events exceeding $10.00 threshold</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: 10, borderBottom: '1px solid #f1f5f9' }}>
                <div>
                  <div style={{ fontWeight: 600, fontSize: '0.86rem', color: '#0f172a' }}>{row.player}</div>
                  <div style={{ fontSize: '0.74rem', color: '#64748b' }}>{row.item}</div>
                </div>
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontWeight: 700, fontSize: '0.92rem', color: '#0f172a', fontFamily: 'Outfit' }}>{row.amount}</div>
        ...
        <div className="mgms-card" style={{ padding: 24 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '1.05rem', fontWeight: 700, color: '#0f172a' }}>
              <Radio size={16} color="#6366f1" /> Live Operations
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 14px', background: '#f8fafc', borderRadius: 8 }}>
                <div>
                  <div style={{ fontWeight: 600, fontSize: '0.86rem', color: '#0f172a' }}>{ev.name}</div>
                  <div style={{ fontSize: '0.72rem', color: '#64748b' }}>{ev.desc}</div>
                </div>
